...
import { Users, ShieldCheck, FileText, Loader2, CheckCircle2, AlertCircle } from "lucide-react";

type DetailedUser = { 
  id: string; 
  email: string; 
  kyc_status: 'Full' | 'Partial' | 'None';
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-mono text-gray-400 uppercase">ID: {user.id.slice(0, 8)}</p>
                </div>
              </div>

              {/* Status Logic */}
              <div className="flex flex-wrap gap-3 items-center">
                {/* Level Display: Always shows Level X */}
